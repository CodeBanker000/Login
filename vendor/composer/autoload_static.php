...
class ComposerStaticInitf6e49446fe2d6dcb6d64d052e22672ca
{
    ...
    public static $classMap = array (
        'App\\Auth\\Auth' => __DIR__ . '/../..' . '/Core/Auth/Auth.php',
        ...
        'Modules\\Index\\Main' => __DIR__ . '/../..' . '/Modules/Index/Main.php',
        'Odan\\Session\\Exception\\SessionException' => __DIR__ . '/..' . '/odan/session/src/Exception/SessionException.php',
        'Odan\\Session\\Flash' => __DIR__ . '/..' . '/odan/session/src/Flash.php',
        'Odan\\Session\\FlashInterface' => __DIR__ . '/..' . '/odan/session/src/FlashInterface.php',
        'Odan\\Session\\MemorySession' => __DIR__ . '/..' . '/odan/session/src/MemorySession.php',
        'Odan\\Session\\Middleware\\SessionMiddleware' => __DIR__ . '/..' . '/odan/session/src/Middleware/SessionMiddleware.php',
        'Odan\\Session\\PhpSession' => __DIR__ . '/..' . '/odan/session/src/PhpSession.php',
        'Odan\\Session\\SessionAwareInterface' => __DIR__ . '/..' . '/odan/session/src/SessionAwareInterface.php',
        'Odan\\Session\\SessionAwareTrait' => __DIR__ . '/..' . '/odan/session/src/SessionAwareTrait.php',
        'Odan\\Session\\SessionInterface' => __DIR__ . '/..' . '/odan/session/src/SessionInterface.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitf6e49446fe2d6dcb6d64d052e22672ca::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitf6e49446fe2d6dcb6d64d052e22672ca::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInitf6e49446fe2d6dcb6d64d052e22672ca::$classMap;
